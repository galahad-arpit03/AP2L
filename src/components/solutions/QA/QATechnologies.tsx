...
const technologies = [
  ...
  },
  {
    ...
    name: "Backend & APIs",
    icon: Code2,
    items: ["Node.js", "Python", "Java", "Go", "Rust", "Spring Boot"],
  },
  {
    id: "database",
  ...
  },
  {
    ...
    name: "CI/CD & DevOps",
    icon: GitBranch,
    items: ["Jenkins", "GitHub Actions", "GitLab CI", "Argo CD", "Terraform"],
  },
  {
    id: "security",
    name: "Security Testing",
    icon: Lock,
    items: ["OWASP", "SAST", "DAST", "Snyk", "Trivy", "Aqua"],
  },
  {
    id: "automation",
    name: "Test Automation",
    icon: Boxes,
    items: ["Selenium", "Cypress", "Playwright", "Appium", "JUnit", "TestNG"],
  },
];
  ...
  return (
    <section className="relative w-full py-16 md:py-20 bg-slate-50 dark:bg-slate-950 transition-colors duration-500 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-4 lg:px-8 z-10">
        ...
        {/* Technologies Grid – smaller cards, single theme */}
        <motion.div 
        ...
        {/* Integration CTA – updated with theme colours
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
